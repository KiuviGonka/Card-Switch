    ...
    mod.hook('S_LOAD_TOPO', 3, (event) => 
		{
			...
			// No type
				if (zoneId == 9713||zoneId ==9126) 
					{
						losnn('basic')
						mod.command.message('<font color="#fff317">Card set mode</font> - <font color="#fff317">None Type -</font>  ${mode ? "Dps" : "goblin"}');
						return true;
					}
			...
			// Argon set
					...
					{
						losnn('argon');
						mod.command.message('<font color="#fff317">Card set mode </font> - <font color="#fff317">Argon - </font> ${mode ? "Dps" : "goblin"}');
						return true;
					}
			...
			// Demon set
					...
					{
						losnn('demon')
						mod.command.message('<font color="#fff317">Card set mode </font> - <font color="#fff317">Demon -</font> ${mode ? "Dps" : "goblin"}');
						return true;
					}
			...
			// Giant Set
					...
					{
						losnn('giant')
						mod.command.message('<font color="#fff317">Card set mode </font> - <font color="#fff317">Giant - </font>${mode ? "Dps" : "goblin"}');
						return true;
					}
		    ...
		    // Ancestor set
					...
					{
						losnn('ancestor')
						mod.command.message('<font color="#fff317">Card set mode </font> - <font color="#fff317">Ancestor -</font> ${mode ? "Dps" : "goblin"}');
						return true;
					}
			...
			// God set
				if(zoneId == 9044) 
					{
						losnn('god')
						mod.command.message('<font color="#fff317">Card set mode </font> - <font color="#fff317">God - </font>${mode ? "Dps" : "goblin"}');
						return true;
					}
			...
			// Magical device
				if(zoneId == 3034) 
					{
						losnn('device')
						mod.command.message('<font color="#fff317">Card set mode </font> - <font color="#fff317">Magical Device - </font>${mode ? "Dps" : "goblin"}');
						return true;
					}
